...
<body>
<p style="font-size: 20px" align="center">SUSPENDED CARDS</p>
...
<div align="center">
    <label style="font-size: 12px">Assigning the card to an owner will unlock all accounts conflicted on the same Breeze Card.</label>
</div>
