...
$end_result = mysqli_query($connection, "SELECT StopID FROM Station WHERE Name = '$end'");
$breezecard_value = mysqli_query($connection, "UPDATE Breezecard SET Value = '$value'") or die("DB error");
